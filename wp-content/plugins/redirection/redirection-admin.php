...
<div class="updated" id="message" onclick="this.parentNode.removeChild(this)">
	...
	function admin_menu() {
  		add_management_page( __( "Redirection", 'redirection' ), __( "Redirects", 'redirection' ), apply_filters( 'redirection_role', 'administrator' ), basename( REDIRECTION_FILE ), array( &$this, "admin_screen" ) );
	}
